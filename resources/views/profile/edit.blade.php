...
<body>
  ...
  <nav class="navbar sticky-top navbar-expand-sm bg-dark navbar-dark">
    ...
    <ul class="navbar-nav ">
      ...
      @if($user2->status==1)
      {!! Form::open(['action' => ['TeacherController@get_list',$user2->user_id],'method' => 'GET']) !!}
      <li class="nav-item"  id="4">
          <a  class="nav-link" href="/teacher/{{$user2->user_id}}/selected">Generate Results</a>
      </li>
      {!! Form::close() !!}

      {!! Form::open(['action' => ['TeacherController@show_list',$user2->user_id],'method' => 'GET']) !!}
      <li class="nav-item"  id="4">
